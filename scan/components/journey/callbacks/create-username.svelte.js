...
/* src/lib/components/journey/callbacks/create-username.svelte generated by Svelte v3.47.0 */
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(input, "change", /*setValue*/ ctx[7]);
				mounted = true;
			}
		},
		p(ctx, [dirty]) {
...
class Create_username extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { callback: 8, inputName: 0 });
	}
}

export { Create_username as default };
